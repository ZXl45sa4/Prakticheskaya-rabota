...
async def get_buying_list(message):
    with open('files/1.jpg', "rb") as img1:
        await message.answer_photo(img1, f'Название: Product1 | Описание: описание 1 | Цена: {1 * 100}')
    with open('files/2.jpg', "rb") as img2:
        await message.answer_photo(img2, f'Название: Product2 | Описание: описание 2 | Цена: {2 * 100}')
    with open('files/3.jpg', "rb") as img3:
        await message.answer_photo(img3, f'Название: Product3 | Описание: описание 3 | Цена: {3 * 100}'),
    with open('files/4.jpg', "rb") as img4:
        await message.answer_photo(img4, f'Название: Product4 | Описание: описание 4 | Цена: {4 * 100}'),
